                ...
                <section className="quote-panel">
                  ...
                  <dl className="quote-kpi-list">
                    ...
                    <div className="quote-emphasis-row">
                      <dt>{options.showWaste ? `Billable ${wRates.rateUnit || 'CFT'}` : `Quoted ${wRates.rateUnit || 'CFT'}`}</dt>
              ...
              {activeUsePly && (
                <section className="quote-panel">
                  ...
                  <dl className="quote-kpi-list">
                    ...
                    <div className="quote-emphasis-row">
                      <dt>{options.showWaste ? `Billable ${pRates.rateUnit || 'CFT'}` : `Quoted ${pRates.rateUnit || 'CFT'}`}</dt>
                      ...
                      {options.showWaste && (
                        <>
                          <tr className="quote-volume-row">
                            ...
                            <td style={{ textAlign: 'right' }}>{formatCFT(wResult.totalCFT)}</td>
                            <td style={{ textAlign: 'right' }}>{formatCFT(pResult.totalCFT)}</td>
                            <td style={{ textAlign: 'right', fontWeight: 'bold' }}>-</td>
                          </tr>
                          <tr className="quote-volume-row">
                            <td style={{ fontWeight: 'semibold' }}>Waste Factor</td>
                            <td style={{ textAlign: 'right' }}>+ {formatCFT(wResult.vestCFT)} <span style={{ fontSize: '8px', color: '#64748b' }}>({wResult.wastePct}%)</span></td>
                            <td style={{ textAlign: 'right' }}>+ {formatCFT(pResult.vestCFT)} <span style={{ fontSize: '8px', color: '#64748b' }}>({pResult.wastePct}%)</span></td>
                            <td style={{ textAlign: 'right', fontWeight: 'bold' }}>-</td>
                          </tr>
                          <tr className="quote-volume-row quote-billable-row">
                            <td style={{ fontWeight: 'bold' }}>Billable Vol</td>
                            <td style={{ textAlign: 'right' }}>{formatCFT(wResult.billable)}</td>
                            <td style={{ textAlign: 'right' }}>{formatCFT(pResult.billable)}</td>
                            <td style={{ textAlign: 'right', fontWeight: 'bold' }}>-</td>
                          </tr>
                        </>
                      )}
                      ...
                      {options.showWaste && (
                        <>
                          <tr className="quote-volume-row">
                            ...
                            <td>{formatCFT(wResult.totalCFT)}</td>
                          </tr>
                          <tr className="quote-volume-row">
                            <th>Waste Factor ({wRates.wastePct ?? 10}%)</th>
                            <td>+ {formatCFT(wResult.vestCFT)}</td>
                          </tr>
                          <tr className="quote-volume-row quote-billable-row">
                            <th>Billable {wRates.rateUnit || 'CFT'}</th>
                            <td>{formatCFT(wResult.billable)}</td>
                          </tr>
                        </>
                      )}
                      {options.showProfit ? (
                        <>
                          ...
                          <tr>
                            <th>Profit ({wRates.profitPct ?? 20}%)</th>
